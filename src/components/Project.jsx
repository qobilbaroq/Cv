  ...
  return (
    ...
    >
      ...
      <div className=" flex flex-col gap-8 md:gap-0 md:flex-row md:justify-evenly m-auto md:m-0">
        <div
          className=" w-[300px] md:w-[550px] h-[425px] shadow-lg border-2 border-neutral-500 rounded-b-xl"
          data-aos="fade-right"
          data-aos-delay="300"
        >
          <img src={pp} className="h-72 w-[550px]" />
          <div className="p-2 h-[111px] ">
            ...
            <Button classname="bg-slate-700 text-slate-50 hover:bg-slate-50 hover:text-slate-700 py-1 px-5">
              show more
            </Button>
          </div>
        </div>
