...
const Project = () => {
  return (
    <div
      ...
      id="project"
    >
      <div className="flex flex-col items-center" data-aos="fade-zoom-in"
     data-aos-easing="ease-in-back"
     data-aos-delay="300"
     data-aos-offset="0">
        <h5 className="md:text-[50px] text-3xl font-bold" >My Projects</h5>
        ...
        <p className="mt-8 md:text-lg w-72 md:w-auto">
      ...
      <div className=" flex flex-col gap-8 md:gap-0 md:flex-row md:justify-evenly m-auto md:m-0" >
        <div className=" w-[300px] md:w-[550px] h-[425px] shadow-lg border-2 border-neutral-500 rounded-b-xl" data-aos="fade-right" data-aos-delay="300">
          <img
          src={pp}
        ...
        <div className=" w-[300px] md:w-[550px] h-[425px] shadow-lg border-2 border-neutral-500 rounded-b-xl" data-aos="fade-left" data-aos-delay="300">
          <img
          src={pp}
          className="h-72 w-[550px]"
          />
